...
1. Getting a user's Spotify cache token saved into the designated folder ".spotify_caches". Therefore, the following steps (accessing the account as well as creating and filling a playlist) also do not work.
